using System;
using xamarin.beacon.Droid.Services;
using System.Collections.Generic;
using System.Threading.Tasks;
using xamarin.beacon;
...
namespace xamarin.beacon.Droid.Services
{
	public class AltBeaconService : Java.Lang.Object, IbeaconAndroid
	{
		...
		public BeaconTransmitter beaconset
		{
			get
			{
				if (_beaconTransmitter == null)
					_beaconTransmitter = InitalizationTransmitter();
				return _beaconTransmitter;
